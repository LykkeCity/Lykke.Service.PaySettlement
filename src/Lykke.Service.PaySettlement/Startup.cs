...
namespace Lykke.Service.PaySettlement
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PaySettlementLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PaySettlementService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PaySettlement", channelOptions =>
                        {
